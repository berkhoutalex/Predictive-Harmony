...
/* package purescript-bridge-0.14.0.0 */
#ifndef VERSION_purescript_bridge
#define VERSION_purescript_bridge "0.14.0.0"
#endif /* VERSION_purescript_bridge */
#ifndef MIN_VERSION_purescript_bridge
#define MIN_VERSION_purescript_bridge(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  14 || \
  (major1) == 0 && (major2) == 14 && (minor) <= 0)
#endif /* MIN_VERSION_purescript_bridge */
...
#define CURRENT_COMPONENT_ID "backend-0.1.0.0-GG1vBeKoJxIPJHM5GVBkz-bridge"
